...
import 'package:flutter_webrtc_example/src/demo.dart';
import 'package:flutter_webrtc_example/src/pull_stream_sample.dart';
import 'package:flutter_webrtc_example/src/push_screen_sample.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
          appBar: AppBar(
            title: Text('Flutter-WebRTC PULL/PUSH example'),
          ),
          body: demo(),
      ),
    );
      ...
      RouteItem(
          ...
          push: (BuildContext context) {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (BuildContext context) => PullStreamSample()));
          }),
      RouteItem(
          title: 'Push ScreenShare',
          push: (BuildContext context) {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (BuildContext context) => PushScreenSample()));
          }),
    ];
  }
}
